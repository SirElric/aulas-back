                ...
                <div id="contentBox">
                    <div id="registerBox">
                        <form id="form-contact" name="frmRegister" action="<?=$action?>" method="post">
                            ...
                            <input id="profission" type="text" class="inputText name="txtProfession" value="" placeholder="profissão">                                
                            <label id="female">
                               <input type="radio" class="radio" name="rdoGender" value="0">Feminino
                                <span class="checkmark"></span>
                            </label>
                            <label id="male">
                                <input id="" type="radio" class="radio" name="rdoGender" value="1">Masculino
                                <span class="checkmark"></span>
                            </label>                                
