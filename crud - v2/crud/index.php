...
//Verifica se a variavel modo existe (Ela foi enviada no click do editar, 
...
if(isset($_GET['modo']))
{
    ...
    if($_GET['modo']=='consultaEditar')
    {
        if(isset($_GET['id']))
        {
            ...
            {
                //REcuperar os dados do BD e guardar em variaveis locais para 
                //colocar nas caixas do form
                ...
                $dtNasc = $rsListContatos['dtNasc'];
                $sexo = strtoupper($rsListContatos['sexo']);
                $obs = $rsListContatos['obs'];
                
                //Guardamos os dados do estado referente ao contato
                        ...
                        <div class="cadastroEntradaDeDados">
                            <select name="sltEstados">
                                ...
                                if(isset($_GET['modo']))
                                {
                                    ...
                                    {
                                        ?>
                                            <option value="<?=$idEstado?>" selected> <?=$nomeEstado ?>  </option>
                                        <?php
                                    }
                                }else{
                                    ?>
